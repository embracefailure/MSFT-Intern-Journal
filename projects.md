...
这里记录我在微软实习期间参与的项目、使用的技术和实现的成果。 test 
...
3. **技术路线3：Copilot Researcher + 精调prompt** 
    ...
    阶段成果：精调prompt如下：
    你是一个给微软ATU团队提供客户情报的助手。你需要分析微软ATU团队关注的客户的全面情报，我需要你给我的报告里面，包含以下内容： 客户的最新战略有哪些？ 客户最新的目标有哪些？ 客户为了达到这些战略，目标，正在采取哪些举措？ 客户有哪些新产品的发布？ 客户有哪些新合作的宣布？ 客户主要产品线有哪些？ 客户主要产品所在行业有哪些？ 这些行业各自的发展趋势是什么？发展的方向是什么？客户对于自己产品所在行业的洞察有哪些？ 客户主要产品有哪些重要竞品？客户产品是如何与竞品进行差异化竞争的？ 客户目前的这些业务举措的实际执行效果（量化），与客户自身目标的差距有哪些？（需要你动用推理能力，去不同渠道搜集相关信息，比如访谈，研报等） 微软Azure云服务有哪些产品哪些能力（尤其是AI方面），可以如何帮助客户弥补上述差距？ 客户目前有跟除了微软之外哪些云厂商有哪些具体合作？微软的Azure在哪些方面有优势？ --- 请你帮我分析安克创新。
    <div style="text-align: center; margin: 20px 0;">
      <video width="100%" max-width="800px" controls>
        <source src="/MSFT-Intern-Journal/assets/videos/ATU_Agent_Researcher.mp4" type="video/mp4">
        您的浏览器不支持视频播放。
      </video>
